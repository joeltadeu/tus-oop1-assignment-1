...
/**
 * Data Transfer Object for loan item responses. Contains information about a specific item within a
 * loan.
 *
...
public record LoanItemResponse(
    @Schema(description = "Unique identifier of the item", example = "789") Long id,
    @Schema(description = "Title of the item", example = "The Great Gatsby") String title,
    @Schema(
            description = "Type of the item",
            example = "BOOK",
            allowableValues = {"BOOK", "JOURNAL"})
        String type,
    @Schema(
            description = "Date when the item was returned, null if not returned",
            example = "2024-01-20")
