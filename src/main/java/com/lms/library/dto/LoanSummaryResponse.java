...
/**
 * Data Transfer Object for loan summary responses. Contains basic information about a loan without
 * item details.
 *
...
public record LoanSummaryResponse(
    @Schema(description = "Unique identifier of the loan", example = "123") Long loanId,
    ...
    @Schema(description = "Current status of the loan", example = "OPEN") String status) {}
