...
/**
 * Represents a journal in the library system. Extends LibraryItem and contains journal-specific
 * properties like ISSN, publisher, volume, and issue.
 *
 * @author Joel Silva
 * @version 1.0
 * @see LibraryItem
...
public final class Journal extends LibraryItem {
  ...
  /**
   * Default constructor for Journal. Required for serialization and dependency injection
   * frameworks.
   */
  public Journal() {}
  ...
  /**
   * Gets the type of library item. Always returns "JOURNAL" for Journal instances.
   *
