...
/**
 * Represents a book in the library system. Extends LibraryItem and contains book-specific
 * properties like ISBN, genre, and page count.
 *
 * @author Joel Silva
 * @version 1.0
 * @see LibraryItem
...
public final class Book extends LibraryItem {
  ...
  /**
   * Default constructor for Book. Required for serialization and dependency injection frameworks.
   */
  public Book() {}
  ...
  /**
   * Gets the type of library item. Always returns "BOOK" for Book instances.
   *
