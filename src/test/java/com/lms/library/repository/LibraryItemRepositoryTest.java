...
class LibraryItemRepositoryTest {
    ...
    void save_MultipleItems_ShouldGenerateSequentialIds() {
        ...
        var journal = new Journal("Journal 1", "Publisher", LocalDate.now(),
    ...
    void findAvailableItems_ShouldReturnOnlyAvailableItems() {
        ...
        var unavailableBook = new Book("Unavailable Book", "Author", LocalDate.now(), "222", "Cat", 200);
    ...
    void findAvailableBooks_ShouldReturnOnlyAvailableBooks() {
        ...
        var availableJournal = new Journal("Available Journal", "Publisher",
    ...
    void findAvailableJournals_ShouldReturnOnlyAvailableJournals() {
        ...
        var unavailableJournal = new Journal("Unavailable Journal", "Publisher",
    ...
    void saveAndRetrieve_DifferentItemTypes_ShouldMaintainType() {
        ...
        var journal = new Journal("Test Journal", "Publisher", LocalDate.now(),
